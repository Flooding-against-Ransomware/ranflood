...
These files are mainly those generated by the ransomware (i.e., the files of the encrypted user) and the random decoy files generated by Ranflood. In case Ranflood used a copy-based strategy, 
